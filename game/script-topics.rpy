...
label talk_learning_languages:
    ...
    if already_discussed_learning_languages:
        ...
        extend 1kslan " Yeesh."
        n 1tnmaj "But anyway,{w=0.1} it's like I said before.{w=0.5}{nw}"
        extend 1kbkwr " Learning a new language is super hard!"
        ...
        n 1uchgn "Moin moin,{w=0.1} [player]!{w=0.75}{nw}"
        extend 1usqsm " What's new?{w=0.5}{nw}"
        extend 1fchss " Ehehe."
        n 1fcsbs "Betcha didn't know I don't just speak English,{w=0.1} huh?"
    ...
    n 1tsqpu "Plus,{w=0.1} with how complex all the rules are and how much repetition you need,{w=0.5}{nw}"
    ...
    n 1nsqpo "I just wish we got to actually,{w=0.1} well..."
    n 1kslpo "{i}Learn them{/i},{w=0.1} you know?"
    n 1fcsss "Heh.{w=0.5}{nw}"
    extend 1fslsr " Not like any of that ever stopped {i}Monika{/i},{w=0.1} of course."
    ...
    if get_topic("talk_flying").shown_count > 0:
        ...
        n 1tsqsm "What's a little extra to show some respect,{w=0.1} right?"
    ...
    extend 1nnmbo " that's just me,{w=0.1} I guess."
    n 1tnmss "What about you though,{w=0.1} [player]?"
    ...
    menu:
        ...
        "I know another language.":
            if persistent._jn_player_is_multilingual:
                ...
                n 1fsrbol "Wow,{w=0.1} [player]..."
                n 1tsqss "...You really are a show-off,{w=0.1} huh?{w=0.5}{nw}"
                extend 1fsqsm " Ehehe."

            else:
                n 1tsqbg "Oho?{w=0.75}{nw}"
                extend 1fsqbg " Well,{w=0.1} look at you!{w=0.5}{nw}"
                extend 1fsqss " Better not get too cocky now,{w=0.1} [player]..."
                n 1usqsm "You aren't the {i}only{/i} multilingual here,{w=0.1} after all.{w=0.5}{nw}"
                extend 1fsqsm " Ehehe."
        ...
        "I know multiple other languages.":
            if persistent._jn_player_is_multilingual:
                ...
                n 1fslem "You're {i}such{/i} a show-off,{w=0.1} [player]."
                n 1fsqsm "...Ehehe."

            else:
                n 1fsqsr "..."
                n 1fsrpo "...Show-{w=0.1}off.{w=0.5}{nw}"
                extend 1fsqsm " Ehehe."
                $ persistent._jn_player_is_multilingual = True
        ...
        "I'm trying to learn another language.":
            if persistent._jn_player_is_multilingual:
                ...
                extend 1flrbg " Well,{w=0.1} hey!"
                n 1fsqss "That makes both of us now,{w=0.1} huh?{w=0.5}{nw}"
                extend 1fsqsm " Ehehe."

            else:
                n 1fnmbgesu "Aha!{w=0.5}{nw}"
                extend 1tsqbg " So you're familiar with the struggle too,{w=0.1} huh?"
                n 1fsqsm "Ehehe."
        ...
        "I don't know any other languages.":
            if persistent._jn_player_is_multilingual:
                n 1tsqaj "...Huh?"
                n 1uskemlesh "W-{w=0.1}wait a second!{w=0.5}{nw}"
